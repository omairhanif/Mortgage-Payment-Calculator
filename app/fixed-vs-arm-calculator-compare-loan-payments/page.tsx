    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-4xl px-6 sm:px-8 py-8">
        <div className="relative w-full aspect-video rounded-xl overflow-hidden shadow-lg">
          <Image
            src="/images/articles/fixed-vs-arm-calculator-compare-loan-payments.jpg"
            alt="Fixed vs ARM calculator comparison"
            fill
      ...
      <article className="pb-2">
        <div className="mx-auto max-w-3xl px-6 sm:px-8">
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <p className="text-base text-slate-600 leading-relaxed mb-6">
              Both fixed-rate and ARM initial payments use the same standard mortgage payment formula: M = P[r(1+r)^n] / [(1+r)^n - 1], where M is monthly payment, P is principal (loan amount), r is monthly interest rate (annual rate Ã· 12), and n is total number of payments (loan term in years Ã  12). The difference emerges after an ARM's fixed period ends at that point, the payment is recalculated using the remaining loan balance, the new adjusted interest rate, and the remaining loan term.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-5">
                ...
                <ul className="space-y-2 text-sm text-slate-600">
                  <li>  Monthly interest rate: 6.75% Ã· 12 = 0.005625</li>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-5">
                ...
                <ul className="space-y-2 text-sm text-slate-600">
                  <li>  Initial monthly rate: 6.00% Ã· 12 = 0.005</li>

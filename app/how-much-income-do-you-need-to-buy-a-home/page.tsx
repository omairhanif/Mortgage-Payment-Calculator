...
export default function HowMuchIncomeArticle() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "The 28/36 rule is a U.S. guideline: housing costs should be â‰¤28% of gross income (front-end ratio) and total debts â‰¤36% (back-end ratio). Canada uses similar but slightly different ratios: (1) Gross Debt Service (GDS) housing costs should be â‰¤32-39% of gross income (varies by lender and insurer), and (2) Total Debt Service (TDS) all debt payments should be â‰¤40-44% of gross income. Example with $6,000 monthly gross: Canada allows ~$1,920-2,340 for housing (32-39%) and ~$2,400-2,640 for all debts (40-44%). The U.S. 28/36 rule would allow $1,680 for housing and $2,160 for all debts. Canadian limits are generally slightly more generous, but the mortgage stress test offsets this by requiring qualification at higher interest rates."
    },
    {
          ...
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <div className="space-y-8">
              ...
              <div className="border-l-4 border-slate-300 pl-6">
                ...
                <p className="text-slate-700 leading-relaxed">
                  Debt-to-income (DTI) ratio measures your monthly debt payments as a percentage of gross monthly income. Canada uses two ratios: GDS (Gross Debt Service) for housing costs only, and TDS (Total Debt Service) for all debts. GDS calculation: (mortgage P&I + property taxes + heating + 50% condo fees) Ã· gross monthly income must be â‰¤32%. TDS calculation: (all GDS costs + car payments + student loans + credit card minimums + child support + other loans) Ã· gross monthly income must be â‰¤42%. Example: $100,000 income = $8,333/month gross. Housing costs of $2,500 = 30% GDS âœ“. Add $600 other debts = $3,100 total Ã· $8,333 = 37.2% TDS âœ“. Both ratios must pass. If either exceeds limits, you must reduce home price, pay off debts, or increase income. These ratios protect borrowers from overextending and lenders from default risk. Higher ratios (up to 44% TDS) possible with compensating factors like excellent credit (760+), large down payment (25%+), or significant reserves (12+ months payments saved).
                </p>
              </div>

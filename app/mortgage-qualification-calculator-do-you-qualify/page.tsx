      ...
      <article className="pb-2">
        <div className="w-full mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <p className="text-base text-slate-600 leading-relaxed mb-4">
              For simple interest (rarely used in consumer loans), you would pay $500 per year on that $10,000 calculated as $10,000 Ã  0.05 = $500. Most consumer loans use compound or amortized interest, where interest is calculated on the remaining balance each payment period. As you pay down the principal, the interest portion of each payment decreases while the principal portion increases. This is why early mortgage payments are mostly interest, while later payments are mostly principal.
            </p>

      ...
      <article className="pb-2">
        <div className="w-full mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <p className="text-base text-slate-600 leading-relaxed mb-4">
              <strong>Real-World Example:</strong> Homeowner draws $60,000 at 8.75% (Prime 7.75% + 1% margin). Monthly payment: ($60,000 Ã  0.0875) Ã· 12 = $437.50/month interest-only. Six months later, Fed raises rates and Prime increases to 8.25%. New rate: 9.25%, new payment: $462.50/month a $25 increase from rate change alone.
            </p>

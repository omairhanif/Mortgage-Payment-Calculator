          ...
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <section className="mb-12">
              ...
              <div className="space-y-4 my-8">
                <div className="border-l-4 border-slate-300 bg-slate-50 p-5 rounded-r-lg">
                  <h4 className="font-bold text-slate-900 mb-2">1. Credit Score</h4>
                ...
                <div className="border-l-4 border-slate-300 bg-slate-50 p-5 rounded-r-lg">
                  <h4 className="font-bold text-slate-900 mb-2">2. Loan-to-Value Ratio (LTV)</h4>
                  <p className="text-slate-700">
                ...
                <div className="border-l-4 border-slate-300 bg-slate-50 p-5 rounded-r-lg">
                  <h4 className="font-bold text-slate-900 mb-2">3. Loan Amount</h4>
                  <p className="text-slate-700">
                ...
                <div className="border-l-4 border-slate-300 bg-slate-50 p-5 rounded-r-lg">
                  <h4 className="font-bold text-slate-900 mb-2">4. Property Type</h4>
                  <p className="text-slate-700">
                ...
                <div className="border-l-4 border-slate-300 bg-slate-50 p-5 rounded-r-lg">
                  <h4 className="font-bold text-slate-900 mb-2">5. Lender Type & Competition</h4>
                  <p className="text-slate-700">
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6 my-8">
                <div className="bg-slate-50 p-6 rounded-lg border-l-4 border-slate-300">
                  <h3 className="font-bold text-slate-900 text-xl mb-3">Step 1: Rate Sheet Analysis</h3>
                ...
                <div className="bg-slate-50 p-6 rounded-lg border-l-4 border-slate-300">
                  ...
                  <div className="bg-white p-4 rounded border border-slate-200">
                    ...
                    <p className="text-slate-900 font-semibold">+ Discount Points (1.5): $6,240</p>
              ...
              <div className="bg-slate-50 border-l-4 border-red-500 p-5 my-6 rounded-r-lg">
            ...
            <section className="mb-12">
              ...
              <div className="bg-slate-50 border-l-4 border-amber-500 p-6 my-8 rounded-r-lg">
                <p className="font-semibold text-slate-900 mb-3">Ottawa Rental Property Example:</p>
            ...
            <section className="mb-12">
              ...
              <div className="bg-slate-50 border-l-4 border-slate-300 p-6 my-8 rounded-r-lg">
                <p className="font-semibold text-slate-900 mb-3">Montreal Break-Even Scenario:</p>
                <p className="text-slate-700 mb-2">

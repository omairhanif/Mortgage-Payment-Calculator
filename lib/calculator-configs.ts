    ...
    subCalculators: {
      "fixed-vs-arm": {
        ...
        inputs: [
          ...
          { id: "loanAmount", label: "Loan Amount", type: "currency", defaultValue: 320000, min: 0, section: "Loan Information" },
          createLoanTermField(30, "Loan Information"),
          createPMIRateField(0.7, "Costs"),
          { id: "discountPoints", label: "Discount / Origination Points", type: "percent", defaultValue: 0, min: 0, max: 5, step: 0.125, section: "Costs", tooltip: "% of loan amount" },
          { id: "otherClosingCosts", label: "Other Closing Costs", type: "currency", defaultValue: 5000, min: 0, section: "Costs" },
          createInterestRateField(6.5, "Rate Information"),
          ...
          { id: "armFirstAdjustmentCap", label: "ARM First Adjustment Cap", type: "percent", defaultValue: 2, min: 0, max: 10, step: 0.25, section: "ARM Settings" },
          { id: "armSubsequentAdjustmentCap", label: "ARM Subsequent Adjustment Cap", type: "percent", defaultValue: 2, min: 0, max: 10, step: 0.25, section: "ARM Settings" },
        ...
        results: [
          { id: "fixedInitialMonthlyPayment", label: "Fixed: Initial Monthly Payment", format: "currency", isPrimary: true },
          { id: "fixedMonthlyPI", label: "Fixed: P&I", format: "currency" },
          { id: "fixedTotalInterest", label: "Fixed: Total Interest", format: "currency" },
          { id: "fixedLTV", label: "Fixed: LTV Ratio", format: "percent" },
          { id: "armInitialMonthlyPayment", label: "ARM: Initial Monthly Payment", format: "currency", highlight: true },
          { id: "armMaximumMonthlyPayment", label: "ARM: Maximum Monthly Payment", format: "currency", highlight: true },
      ...
      "interest-only": {
        ...
        inputs: [
          ...
          { id: "loanAmount", label: "Loan Amount", type: "currency", defaultValue: 280000, min: 0, section: "Loan Information" },
          createLoanTermField(30, "Loan Information"),
          ...
          createInterestRateField(6.0, "Rate Information"),
        ...
        results: [
          ...
          { id: "postIOAmortizingPayment", label: "Post-IO Amortizing Payment", format: "currency", highlight: true },
          { id: "loanAmount", label: "Loan Amount", format: "currency" },
      ...
      "balloon": {
        ...
        inputs: [
          ...
          { id: "loanAmount", label: "Loan Amount", type: "currency", defaultValue: 240000, min: 0, section: "Loan Information" },
          createInterestRateField(5.5, "Rate Information"),
          ...
          { id: "loanOriginationFeePercent", label: "Loan Origination Fee", type: "percent", defaultValue: 1, min: 0, max: 10, step: 0.25, section: "Fees" },
          { id: "financeIntoLoan", label: "Finance Origination Fee into Loan", type: "checkbox", defaultValue: false, section: "Fees" },
        ],
        ...
        results: [
          ...
          { id: "balloonPayment", label: "Balloon Payment Due at Term End", format: "currency", highlight: true },
          { id: "totalInterestBeforeBalloon", label: "Total Interest Paid Before Balloon", format: "currency" },
        ],
        showAmortization: false,
        showChart: false,
      },

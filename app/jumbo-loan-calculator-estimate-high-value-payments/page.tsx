        ...
        <div className="w-full mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <ul className="list-none space-y-2 text-base text-slate-600 mb-6">
              ...
              <li>  Property Taxes ($950K Ã  1.2% Ã· 12): $950/month</li>
            ...
            <ul className="list-none space-y-2 text-base text-slate-600 mb-6">
              <li>  Monthly interest rate: 7.00% Ã· 12 = 0.005833</li>
              <li>  (1+r)^360 = 8.1247</li>
              <li>  Monthly P&I = 1,125,000[0.005833 Ã  8.1247] / [8.1247 - 1]</li>
            ...
            <ul className="list-none space-y-2 text-base text-slate-600 mb-6">
              ...
              <li>  Property Taxes ($1.5M Ã  1.25% Ã· 12): $1,563/month</li>

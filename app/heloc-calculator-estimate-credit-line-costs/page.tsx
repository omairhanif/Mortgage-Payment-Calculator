  ...
  const allFaqs = [
    {
      ...
      a: "Most lenders allow 80-85% combined loan-to-value (CLTV)â€”meaning your first mortgage plus HELOC can't exceed 80-85% of home value. Formula: (Home Value Ã— 0.80) - Existing Mortgage = Available HELOC. Example: $600K home with $400K mortgage = $80K maximum HELOC (at 80% CLTV). Actual amount depends on credit score (680+ typically required), income/DTI ratio (43% max), and appraisal. Use \"second mortgage calculator how much can i borrow\" tools for estimates, but expect appraisal to determine final amount. Canada and UK calculators may show different limits due to local regulations."
    },
    {
      q: "How do I qualify for a 2nd mortgage?",
      a: "Lenders evaluate: (1) Credit scoreâ€”680+ preferred, 620 minimum for conventional HELOCs, (2) Debt-to-income ratioâ€”43% maximum including HELOC payment, (3) Home equityâ€”15-20% remaining after HELOC required, (4) Income documentationâ€”2 years tax returns, recent paystubs for W-2 earners; 2 years business/personal returns for self-employed, (5) Reservesâ€”2 months housing payments in savings. Most qualification denials stem from insufficient equity (home hasn't appreciated enough) or DTI exceeding limits (too much existing debt)."
    },
    {
    ...
    },
    {
      ...
      a: "The 2-2-2 rule requires: (1) 2 years employment history in same field, (2) 2 years tax returns documenting income, (3) 2 months mortgage payment reserves in savings. For HELOCs, lenders apply this guideline to verify stabilityâ€”income must be consistent over time, and borrower must have financial cushion for emergencies. Self-employed borrowers particularly affected (need full 2 years business tax returns showing profit). Job changes within same industry generally acceptable if income remains stable or increases. Reserves calculated as 2 months Ã— (first mortgage + HELOC payment + property taxes/insurance)."
    },
    {
      q: "What's the difference between HELOC draw period and repayment period payments?",
      a: "Draw period (typically 10 years): Access funds as needed, pay interest-only on outstanding balance. Example: $60K drawn at 8.75% = $437/month. Repayment period (typically 20 years after draw ends): Can no longer borrow, must repay principal + interest. Same $60K at 8.75% over 20 years = $554/monthâ€”27% payment increase. Use \"second mortgage calculator payment\" tools to model both phases. Paying extra principal during draw period reduces repayment period shock. Many borrowers refinance before repayment period hits to avoid payment jump."
    },
    {
      q: "Can I use a second mortgage calculator with extra payments to pay off my HELOC faster?",
      a: "Yesâ€”\"second mortgage calculator with extra payments\" tools show how additional principal reduces balance and interest costs. Example: $60K HELOC at 8.75%, $437/month required (interest-only). Adding $200/month extra principal during 10-year draw period reduces balance to ~$31K by repayment period start, cutting future payment from $554 to $286/month. Key difference: HELOCs are revolvingâ€”you can re-borrow paid-down amounts during draw period (requires discipline). Extra payments most effective when rates are low or risingâ€”prevents payment shock if rates increase during draw period."
    },
    {
      q: "How do second mortgage calculator Canada/UK versions differ from US calculators?",
      a: "Core math is identical (home value Ã— LTV - mortgage = available equity), but regulations differ significantly. Canada: Stress test requiredâ€”must qualify at higher rate (~2% above actual), affecting affordability. CIBC second mortgage and RBC second mortgage products follow strict OSFI guidelines; second mortgage rates Canada currently 7-9%. UK: \"Second mortgage calculator Halifax\" and similar tools reflect FCA regulations, typically cap at 75% LTV, use \"further advance\" terminology. Ireland/NZ: Similar CLTV principles but country-specific caps. Always use calculators specific to your countryâ€”qualification rules and typical second mortgage rates Ontario vs. Texas vs. London vary significantly."
    },
    {
      q: "Can I use a HELOC to buy another house?",
      a: "Yesâ€”common strategy for investment property or second home down payments. Example: $750K primary home with $425K mortgage allows $175K HELOC (80% CLTV). Use $95K for 20% down on $450K investment property. Costs: HELOC interest (~$712/month on $95K at 9%) + new mortgage (~$2,396/month on $360K). Offset with rental income ($3,200/month) = net $92/month increase over original mortgage. Risks: vacancy periods, HELOC rate increases, qualifying DTI must support both properties. Alternative: \"how to get a second mortgage to buy another house\" via cash-out refinance (fixed rate vs. variable HELOC rate). Many lenders restrict HELOC usage for investment propertiesâ€”verify before applying."
    }
  ];
      ...
      <article className="pb-2">
        <div className="mx-auto max-w-3xl px-6 sm:px-8">
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <p className="text-base text-slate-600 leading-relaxed mb-4">
              <strong>Traditional Second Mortgages:</strong> You receive a lump sum at closingâ€”typically $50,000 to $200,000â€”with a fixed interest rate (currently 8-11% for most borrowers) and fixed monthly payment over 10 to 30 years. From day one, you're paying principal plus interest on the full amount borrowed. A $75,000 second mortgage at 9.5% for 15 years costs $786 monthly, every month, whether you've spent the money or not.
            </p>
            ...
            <p className="text-base text-slate-600 leading-relaxed mb-4">
              The question "how much can I borrow on a 2nd mortgage" starts with understanding Combined Loan-to-Value (CLTV) limitsâ€”the maximum percentage of your home's value that lenders allow across all mortgages combined. Most lenders cap HELOCs at 80-85% CLTV, occasionally reaching 90% for borrowers with excellent credit (750+) and strong income documentation.
            </p>

            <p className="text-base text-slate-600 leading-relaxed mb-4">
              <strong>The Formula:</strong> (Home Value Ã— CLTV%) - Existing Mortgage Balance = Maximum HELOC Available
            </p>
            ...
            <p className="text-base text-slate-600 leading-relaxed mb-4">
              ($625,000 Ã— 0.80) - $410,000 = $500,000 - $410,000 = <strong>$90,000 maximum HELOC</strong>
            </p>
            ...
            <p className="text-base text-slate-600 leading-relaxed mb-4">
              <strong>Real-World Example:</strong> Homeowner draws $60,000 at 8.75% (Prime 7.75% + 1% margin). Monthly payment: ($60,000 Ã— 0.0875) Ã· 12 = $437.50/month interest-only. Six months later, Fed raises rates and Prime increases to 8.25%. New rate: 9.25%, new payment: $462.50/monthâ€”a $25 increase from rate change alone.
            </p>

            <p className="text-base text-slate-600 leading-relaxed mb-6">
              <strong>Reality Check:</strong> Variable rates create uncertainty. Budget for potential 2-3% rate increases. Interest-only payments build no equityâ€”you owe the full balance unless you voluntarily pay extra principal during the draw period.
            </p>
            ...
            <p className="text-base text-slate-600 leading-relaxed mb-4">
              After 10 years, the draw period endsâ€”you can no longer access funds and must repay principal + interest over 20 years (typically). Draw period payment: $462.50/month (interest-only on $60K). Repayment period payment: $554/month (P&I over 20 years). Payment increase: $91.50/month or 20% jump.
            </p>

            <p className="text-base text-slate-600 leading-relaxed mb-6">
              <strong>Worse-Case Scenario:</strong> If balance grew to $85,000 during draw period (re-borrowing for additional projects), repayment period payment jumps to $785/monthâ€”70% increase. Many homeowners refinance before this transition or use home sales to pay off the balance. Those who can't face mandatory payment increases.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-2 text-base text-slate-600 mb-4">
              ...
              <li><strong>Below 620:</strong> Conventional HELOC unlikelyâ€”consider private second mortgage lenders</li>
            </ul>
            ...
            <p className="text-base text-slate-600 leading-relaxed mb-4">
              <strong>Real-World Qualification Example:</strong> Gross monthly income $8,500. First mortgage: $2,100, car loan: $450, credit cards: $150, proposed HELOC repayment payment: $550. DTI: ($2,100 + $450 + $150 + $550) Ã· $8,500 = 38% â†’ <strong>APPROVED</strong>. If income were $7,000: same debts = 47% DTI â†’ <strong>DENIED</strong> (exceeds 43%).
            </p>
            ...
            <p className="text-base text-slate-600 leading-relaxed mb-4">
              <strong>What is the 2 2 2 rule for mortgages?</strong> This industry guideline requires: (1) 2 years employment history in same field, (2) 2 years tax returns documenting income, (3) 2 months reservesâ€”savings equal to 2 months total housing payments.
            </p>

            <p className="text-base text-slate-600 leading-relaxed mb-4">
              <strong>How It Applies to HELOCs:</strong> Lenders evaluate stability through 2-year documentation. Self-employed borrowers especially scrutinized (need 2 years business returns showing consistent profit). Reserve requirement example: First mortgage $2,100/month, HELOC repayment period payment $550/month. Required reserves: 2 Ã— ($2,100 + $550) = $5,300 minimum in savings.
            </p>

            <p className="text-base text-slate-600 leading-relaxed mb-6">
              <strong>Exceptions:</strong> Job changes within same field generally acceptable (engineer â†’ engineer at new company). Less than 2 years employment okay with compensating factors (high credit score, substantial equity). Reserves can include retirement accounts (with 30% discount for potential early withdrawal penalties).
            </p>
            ...
            <p className="text-base text-slate-600 leading-relaxed mb-4">
              <strong>How to get a second mortgage to buy another house:</strong> Tap primary residence equity via HELOC for investment property down paymentâ€”avoids liquidating investments, keeps primary mortgage untouched.
            </p>
            ...
            <p className="text-base text-slate-600 leading-relaxed mb-4">
              <strong>Monthly Carrying Costs:</strong> Primary mortgage $2,650, HELOC interest ($95K at 9%): $712/month interest-only, investment property mortgage: $2,396 (at 7.5% investor rate). Total: $5,758/month. Offset with rental income: $3,200/month (both units). Net cash outlay: $2,558/month vs. $2,650 beforeâ€”only $92/month net increase.
            </p>

            <p className="text-base text-slate-600 leading-relaxed mb-6">
              <strong>Risks:</strong> Vacancy risk (budget for months without rental income), HELOC rate increases affect affordability, qualifying DTI must support both properties. Many lenders cap HELOC usage for investment property down paymentsâ€”verify before applying. Alternative: cash-out refinance on primary vs. HELOC (fixed rate vs. variable).
            </p>

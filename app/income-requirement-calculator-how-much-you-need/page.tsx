        ...
        <div className="mx-auto max-w-3xl px-6 sm:px-8">
          ...
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <p className="text-xl text-slate-700 leading-relaxed mb-8">
              <strong>How much income do you need to buy a home?</strong> It's the first question most aspiring homeowners ask—and the answer depends on far more than just the home's price. In Canada, the mortgage stress test, GDS and TDS ratios, and regional property costs all play critical roles in determining whether you qualify.
            </p>

            <p className="text-slate-700 leading-relaxed mb-6">
              Sarah earned $70,000 per year working as a marketing coordinator in Toronto. When she started house hunting, she assumed she could afford the $350,000 condo she'd been eyeing—after all, with 20% down ($70,000 saved), the mortgage would only be $280,000. But when she used an <strong>income requirement calculator for mortgage</strong> qualification, reality hit: the Canadian stress test meant she had to qualify at a higher interest rate (7.79% instead of her actual 5.79% rate), and her maximum qualifying mortgage was closer to $230,000—not enough for her target home.
            </p>
            ...
            <ul className="list-disc list-inside text-slate-700 mb-6 space-y-2">
              <li><strong>Target home price or mortgage amount</strong> – The property you're considering</li>
              <li><strong>Down payment percentage</strong> – Affects mortgage size and CMHC insurance requirements</li>
              <li><strong>Interest rate</strong> – Current market rate (typically 5.79-6.25% in 2026)</li>
              <li><strong>Stress test rate</strong> – Qualifying rate (contract rate + 2%, or 5.25% minimum, whichever is higher)</li>
              <li><strong>Property taxes</strong> – Regional variation ($200-$800/month depending on location)</li>
              <li><strong>Heating costs</strong> – Required for GDS calculation ($100-$200/month estimate)</li>
              <li><strong>Condo fees (if applicable)</strong> – 50% of monthly strata/condo fees count toward GDS</li>
              <li><strong>Other monthly debts</strong> – Car loans, credit cards, student loans, child support</li>
            </ul>
            ...
            <div className="bg-indigo-50 border-l-4 border-indigo-600 p-6 mb-8 rounded-r-lg">
              ...
              <p className="text-slate-700 mb-4">
                <strong>Formula:</strong> (Principal + Interest + Property Taxes + Heating + 50% Condo Fees) ÷ Gross Monthly Income ≤ 32%
              </p>
              <p className="text-slate-700 mb-4">
              ...
              <p className="text-slate-700">
                <strong>Formula:</strong> (GDS + All Other Debt Payments) ÷ Gross Monthly Income ≤ 42%
              </p>
              <p className="text-slate-700">
            ...
            <p className="text-slate-700 leading-relaxed mb-6">
              Since 2018, Canada requires all homebuyers—even those with 20%+ down payment—to pass the <strong>mortgage stress test</strong>. This regulation, enforced by OSFI (Office of the Superintendent of Financial Institutions), ensures borrowers can still afford payments if rates rise.
            </p>
            ...
            <div className="bg-amber-50 border-l-4 border-amber-500 p-6 mb-8 rounded-r-lg">
              ...
              <ul className="text-slate-700 space-y-2 mb-4">
                ...
                <li>• Mortgage needed: $280,000</li>
                <li>• Other debts: $300/month car payment</li>
              </ul>

              <p className="text-slate-900 font-semibold mb-3">GDS Calculation (32% maximum):</p>
              <ul className="text-slate-700 space-y-2 mb-4">
                <li>• Maximum housing costs: $5,833 × 0.32 = $1,867/month</li>
                <li>• Stress test P&I ($280K at 7.79%): $2,163/month</li>
                <li>• Property tax (Toronto): $350/month</li>
                <li>• Heating estimate: $120/month</li>
                <li>• Condo fee (50% counts): $85/month (half of $170)</li>
                <li>• <strong>Total PITH: $2,718/month</strong></li>
                <li>• GDS ratio: $2,718 ÷ $5,833 = <strong>46.6%</strong> ❌ <span className="text-red-600 font-semibold">FAILS</span> (exceeds 32%)</li>
              </ul>
            ...
            <p className="text-slate-700 leading-relaxed mb-6">
              Here's the reverse calculation—<strong>how much mortgage you can get based on your annual salary</strong> in Canada. These estimates assume 20% down payment, $400/month property taxes, $150/month heating, and minimal other debts ($200/month).
            </p>
            ...
            <p className="text-slate-700 leading-relaxed mb-6">
              Landlords and property management companies use <strong>income requirement calculators for rent</strong> to screen tenants. The standard rule: monthly gross income must be <strong>2.5× to 3× monthly rent</strong>.
            </p>
            ...
            <p className="text-slate-700 leading-relaxed mb-6">
              <strong>Example:</strong> Raj earns $90,000/year and buys a $550,000 home with a $2,000/month basement rental. His lender uses 65% of rental income: $2,000 × 0.65 = $1,300/month additional income. Combined qualifying income: $7,500 + $1,300 = $8,800/month, increasing his maximum mortgage from $350,000 to $440,000.
            </p>
            ...
            <ul className="list-disc list-inside text-slate-700 mb-6 space-y-2">
              <li><strong>CPP/OAS pensions</strong> – Must show award letters and 3+ years continuity</li>
              <li><strong>RRSP/RRIF withdrawals</strong> – Must document sustainable draw rate (typically 4-5% annually)</li>
              <li><strong>Company pensions</strong> – Full monthly amount counts if guaranteed for 3+ years</li>
              <li><strong>Annuities</strong> – Monthly payment counts with documentation</li>
            </ul>

            <p className="text-slate-700 leading-relaxed mb-6">
              <strong>Age consideration:</strong> Lenders typically don't discriminate based on age, but amortization may be limited—some lenders cap amortization so the mortgage matures by age 80-85.
            </p>
            ...
            <p className="text-slate-700 leading-relaxed mb-6">
              <strong>AOS (Affidavit of Support) Income Requirements:</strong> For US immigration sponsorship, requires 125% of federal poverty guidelines—this is immigration income verification, not mortgage qualification. The two calculations serve different purposes and shouldn't be confused.
            </p>
            ...
            <div className="mt-12 border-t border-slate-200 pt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Link href="/how-much-income-do-you-need-to-buy-a-home" className="text-indigo-600 hover:text-indigo-700 hover:underline">

    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-4xl px-6 sm:px-8">
        ...
        <div className="mt-4 mb-6 flex justify-center">
          <Link
            href="/income-requirement-calculator"
        ...
        <div className="w-full mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <div className="bg-slate-50 border-l-4 border-amber-500 p-6 mb-8 rounded-r-lg">
              ...
              <ul className="text-slate-700 space-y-2 mb-4">
                <li>  Maximum housing costs: $5,833 Ã  0.32 = $1,867/month</li>
                ...
                <li>  GDS ratio: $2,718 Ã· $5,833 = <strong>46.6%</strong> âŒ <span className="text-slate-900 font-semibold">FAILS</span> (exceeds 32%)</li>
              </ul>

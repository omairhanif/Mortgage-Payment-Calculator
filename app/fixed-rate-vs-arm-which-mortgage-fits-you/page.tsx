        ...
        <div className="mx-auto max-w-[1400px] px-6 sm:px-8 lg:px-12">
          <div className="mx-auto max-w-3xl">
            ...
            <ul className="list-disc pl-8 mb-6 space-y-2 text-base text-slate-600">
              ...
              <li><strong>High initial-payment sensitivity:</strong> When qualifying for a fixed-rate mortgage is difficult but the lower ARM payment makes the purchase feasible—though only if you can afford worst-case adjustments.</li>
            </ul>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6 mb-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-4">
                <div className="bg-white border border-blue-300 rounded p-4">
                  <p className="font-bold text-blue-900 mb-2">30-Year Fixed @ 6.75%</p>
                  <ul className="space-y-1 text-xs text-slate-600">
                    <li>• Monthly P&I: <strong>$2,270</strong></li>
                    <li>• Payment never changes</li>
                    <li>• Total interest (30 yrs): ~$467,000</li>
                  </ul>
                </div>
                
                <div className="bg-white border border-green-300 rounded p-4">
                  <p className="font-bold text-green-900 mb-2">5/1 ARM @ 6.00%</p>
                  <ul className="space-y-1 text-xs text-slate-600">
                    <li>• Initial monthly P&I: <strong>$2,098</strong></li>
                    <li>• Years 1-5 savings: $10,320</li>
              ...
              <p className="text-sm font-bold text-blue-900">✓ Verdict: Fixed-Rate Fits Better</p>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-6 mb-6">
              ...
              <p className="text-sm text-slate-600 mb-4">
                <strong>Situation:</strong> You're confident you'll sell within 5-7 years—military assignment, starter home with definite upgrade plans, temporary job location, or expecting family size changes that require moving.
              </p>
              ...
              <div className="bg-white border border-green-300 rounded p-4 mb-4">
                <p className="font-bold text-green-900 mb-3">5-Year Comparison:</p>
                <ul className="space-y-2 text-xs text-slate-600">
                  <li><strong>Fixed @ 6.75%:</strong> Total paid over 5 years = $136,200 (60 months × $2,270)</li>
                  <li><strong>5/1 ARM @ 6.00%:</strong> Total paid over 5 years = $125,880 (60 months × $2,098)</li>
                  <li><strong>ARM Savings: $10,320</strong></li>
                  <li>• You sell before the ARM adjusts—captured all savings with zero adjustment risk</li>
                </ul>
              </div>
              ...
              <p className="text-sm font-bold text-green-900">✓ Verdict: ARM Fits Better</p>
            </div>
            ...
            <div className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-lg p-6 mb-8">
              ...
              <p className="text-sm text-slate-600 mb-4">
                <strong>Situation:</strong> You're buying a home you'll likely outgrow—family expansion expected, career progression anticipated, or planning to upgrade in 7-10 years. You want more initial savings than a 5/1 ARM but aren't committing to 30 years.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-4">
                <div className="bg-white border border-blue-300 rounded p-4">
                  <p className="font-bold text-blue-900 mb-2">30-Year Fixed @ 6.875%</p>
                  <ul className="space-y-1 text-xs text-slate-600">
                    <li>• Monthly P&I: <strong>$2,629</strong></li>
                    <li>• 7-year total: $220,836</li>
                  </ul>
                </div>
                
                <div className="bg-white border border-green-300 rounded p-4">
                  <p className="font-bold text-green-900 mb-2">7/1 ARM @ 6.125%</p>
                  <ul className="space-y-1 text-xs text-slate-600">
                    <li>• Initial monthly P&I: <strong>$2,426</strong></li>
                    <li>• 7-year total: $203,784</li>
                    <li>• Savings: <strong>$17,052</strong></li>
                  </ul>
                </div>
              </div>
              ...
              <p className="text-sm font-bold text-amber-900">✓ Verdict: 7/1 ARM Often Fits Better (if timeline holds)</p>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-lg p-6 mb-6">
              ...
              <div className="space-y-4 text-sm text-slate-600">
                ...
                <div>
                  ...
                  <p>Fixed-rate typically costs less cumulatively unless rates decline significantly. Multiple ARM adjustment cycles introduce too much uncertainty—payment predictability becomes more valuable than initial savings.</p>
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              >
                <Calculator className="h-6 w-6 text-indigo-600 flex-shrink-0" />
                <div>
                  <div className="font-semibold text-slate-900">Fixed vs ARM Calculator</div>
                  <div className="text-sm text-slate-600">Compare payment scenarios</div>
                </div>
                <ChevronRight className="ml-auto h-5 w-5 text-slate-400" />
              </Link>

    ...
    <main className="min-h-screen bg-white">
      ...
      <article className="pb-2">
        <div className="w-full mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-base text-slate-600 leading-relaxed mb-4">
            <strong>Strong renting scenarios:</strong> Uncertain timeline might relocate for work within 5 years. Career instability or income variability. Unable to save 20% down payment or would deplete all savings to buy. High-cost market where purchase price exceeds 20Ã  annual rent. Value flexibility over stability enjoy ability to move easily, try different neighborhoods, avoid maintenance responsibility. Aggressive investor prefer to invest down payment savings in higher-return assets (stocks historically 7-10% vs real estate 3-4%). Short-term life situation graduate school, temporary job, dating and likely to relocate.
          </p>

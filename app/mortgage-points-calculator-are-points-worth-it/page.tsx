              ...
              <div className="space-y-6 my-8">
                <div className="border-l-4 border-slate-300 bg-slate-50 p-5 rounded-r-lg">
                  ...
                  <ul className="space-y-2 text-slate-700">
                    ...
                    <li><strong>Verdict:</strong> âŒ Don't buy points won't reach break-even before likely sale</li>
                  </ul>
                </div>
                ...
                <div className="border-l-4 border-slate-300 bg-slate-50 p-5 rounded-r-lg">
                  ...
                  <ul className="space-y-2 text-slate-700">
                    ...
                    <li><strong>Verdict:</strong> âœ… Buy points will save $12,340 over 15 years after recouping cost</li>
                  </ul>
                </div>
                ...
                <div className="border-l-4 border-slate-300 bg-slate-50 p-5 rounded-r-lg">
                  ...
                  <ul className="space-y-2 text-slate-700">
                    ...
                    <li><strong>Verdict:</strong> âš ï¸ Borderline buy only if very confident you'll stay past 6 years</li>
                  </ul>
                </div>
              </div>

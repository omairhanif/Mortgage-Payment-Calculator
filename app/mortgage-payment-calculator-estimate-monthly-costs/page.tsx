  ...
  const faqs = [
    {
      ...
      a: "A simple mortgage payment calculator typically shows only principal and interest (P&I), giving you the base loan payment. A comprehensive calculator includes property taxes, homeowners insurance, PMI, and HOA feesâ€”your complete monthly housing cost. Most homebuyers need the full picture since lenders qualify you based on total monthly payment, not just P&I. Use a simple calculator for quick loan comparisons, but rely on a complete calculator for budgeting and affordability decisions."
    },
    {

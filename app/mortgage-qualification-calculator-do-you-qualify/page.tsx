        ...
        <div className="mx-auto max-w-3xl px-6 sm:px-8">
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <p className="text-base text-slate-600 leading-relaxed mb-6">
              <strong>Real example from Ontario:</strong> Jennifer, a nurse from Ottawa earning $82,000 annually, used a free mortgage qualification calculator before house hunting. She entered her $6,833 monthly gross income, $450 car payment, $150 student loan payment, and 10% down payment ($50,000). The calculator showed she qualified for a $385,000 mortgageâ€”meaning a $435,000 home purchase price. Her GDS ratio was 31% and TDS ratio was 39%, both within acceptable limits. She focused her home search on properties under $420,000 to stay comfortable, and successfully purchased a $405,000 townhouse with her BMO pre-approval matching the calculator's estimate within $5,000.
            </p>

    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-4xl px-6 sm:px-8">
        ...
        <div className="mt-4 mb-6 flex justify-center">
          <Link
            href="/second-mortgage-calculator"
      ...
      <article className="pb-2">
        <div className="w-full mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <p className="text-base text-slate-600 leading-relaxed mb-4">
              Using the formula: The monthly interest rate is 6.5% Ã· 12 = 0.00542. The number of payments is 30 years Ã  12 = 360 months. Plugging these into the formula yields a principal and interest payment of approximately $1,991 per month. Over 30 years, you'll pay roughly $716,760 total the original $315,000 principal plus $401,760 in interest.
            </p>

      ...
      <article className="pb-2">
        <div className="mx-auto max-w-3xl px-6 sm:px-8">
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <p className="text-base text-slate-600 leading-relaxed mb-4">
              Balance $150,000, Rate 7.45% â†’ <strong>($150,000 Ã— 0.0745) Ã· 12 = $931.25/month interest-only</strong>
            </p>

            <p className="text-base text-slate-600 leading-relaxed mb-6">
              <strong>What is the monthly payment on a $150,000 HELOC?</strong> Approximately $931/month interest-only. Upper limit for many Canadiansâ€”OSFI's 65% cap means $150K HELOC requires $230K+ home equity. Combined with mortgages (80% total limit), typically requires $400K+ home value with minimal mortgage debt.
            </p>
            ...
            <p className="text-base text-slate-600 leading-relaxed mb-4">
              <strong>Formula:</strong> (Outstanding Balance Ã— Annual Rate) Ã· 12 = Monthly Interest-Only Payment
            </p>

            <p className="text-base text-slate-600 leading-relaxed mb-6">
              <strong>Example:</strong> $75,000 balance at 7.70% (Prime 6.95% + 0.75% margin) = ($75,000 Ã— 0.077) Ã· 12 = <strong>$481.25/month</strong>. All major banks offer heloc calculator payment tools: heloc calculator td, heloc calculator scotiabank, bmo heloc calculator, cibc heloc calculator, rbc heloc calculator. These heloc calculator free tools show both interest-only minimums and extra payment scenarios. Heloc calculator ontario and heloc calculator alberta use identical calculationsâ€”rates nationwide based on Bank of Canada Prime.
            </p>
            ...
            <p className="text-base text-slate-600 leading-relaxed mb-4">
              <strong>TD Home Equity FlexLine:</strong> Readvanceable structureâ€”HELOC increases as mortgage paid down. Prime + 0.5% for qualified borrowers. Max: 65% HELOC, 80% combined. The heloc calculator td tool models draw scenarios and extra payment impact.
            </p>
